...
export default function UniversiteDetay() {
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/api/takip/takip-durumu/${uniId}`)
      .then((res) => setIsFollowing(res.data.takipEdiyorMu))
      .catch(() => {});

    axios
      .get(`${BASE_URL}/api/takip/universite/${uniId}/takipciler`)
    ...
    <LinearGradient colors={['#f75c5b', '#ff8a5c']} style={styles.container}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardContent}>
            <Text style={styles.cardItem}>
              • Bahar şenlikleri 24 Nisan'da başlıyor!
            </Text>
            <Text style={styles.cardItem}>
              • Yüz yüze eğitime geçiş duyurusu yayımlandı.
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          style={styles.card}
          onPress={() =>
            navigation.navigate('QuestionList', { universiteId: uniId })
          }
        >
