        ...
        <View style={styles.header}>
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerTitleContainer}>
              ...
              <Text style={styles.headerSubtitle}>SORU OLUŞTUR</Text>
            </View>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text style={styles.pageTitle}>Yeni Soru Oluştur</Text>
              <Text style={styles.pageSubtitle}>
                Merak ettiğin konuyu sor, topluluktan cevap al
              </Text>
            </Animated.View>
              ...
              >
                <View style={styles.infoContent}>
                  ...
                  <Text style={styles.infoText}>
                    Sorunuz topluluk üyeleri tarafından görülecek ve cevaplar alacaksınız.
                  </Text>
                </View>
              </LinearGradient>
            </Animated.View>
