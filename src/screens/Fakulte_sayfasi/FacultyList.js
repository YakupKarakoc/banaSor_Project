    ...
    >
      ...
      >
        <View style={styles.itemIconRow}>
          <Icon name="school-outline" size={22} color="#f75c5b" style={styles.itemIcon} />
  ...
  return (
    <LinearGradient colors={['#f75c5b', '#ff8a5c']} style={styles.container}>
      <View style={styles.header}>
        <Icon name="school-outline" size={32} color="#fff" style={styles.headerIcon} />
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>Fakülte bulunamadı.</Text>
          </View>
        }
      />
    </LinearGradient>
