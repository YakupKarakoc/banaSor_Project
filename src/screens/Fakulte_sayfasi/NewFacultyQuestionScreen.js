// src/screens/NewFacultyQuestionScreen.js
...
export default function NewFacultyQuestionScreen() {
  const { faculty, universite } = useRoute().params;
  ...
  const handleSubmit = () => {
    ...
    setPosting(true);
    axios
      .post(`${BASE}/api/soru/soruOlustur`, payload)
      .then((res) => {
        console.log('✅ Soru oluşturuldu. Backend cevabı:', res.data);
