...
export default function AdminPanelScreen({ navigation, route }) {
 ...
 const handleLeaveAdmin = async () => {
    Alert.alert(
      'Adminlikten Ayrıl',
      'Admin yetkilerinizi kaybedeceksiniz. Bu işlemi geri alamazsınız.\n\nEmin misiniz?',
      [
        {
          text: 'Hayır',
          style: 'cancel',
          onPress: () => {
            // Hiçbir şey yapmadan geri dön
          }
        },
        {
          text: 'Evet, Ayrıl',
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                'Başarılı',
                'Adminlikten ayrıldınız. Ana sayfaya yönlendiriliyorsunuz.',
                [
                  {
                    text: 'Tamam',
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      <LinearGradient colors={['#f75c5b','#ff8a5c']} style={styles.container}>
        ...
        {/* Premium User Management Header */}
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      <LinearGradient colors={['#f75c5b','#ff8a5c']} style={styles.container}>
        ...
        {/* Premium Header with floating design */}
        <View style={styles.modernHeader}>
          <View style={styles.headerContent}>
            <View style={styles.headerTitleContainer}>
              <Text style={styles.modernHeaderTitle}>Admin Panel</Text>
              <Text style={styles.modernHeaderSubtitle}>Yönetim Merkezi</Text>
            </View>
